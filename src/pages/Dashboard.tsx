              ...
              <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-sm">Study daily</p>
                      <p className="text-xs text-muted-foreground">Build your streak for XP bonus</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-sm">Ask the AI Tutor</p>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-sm">Complete chapters</p>
                      <p className="text-xs text-muted-foreground">Earn XP and achievements</p>
                    </div>
                  </div>
                </div>
              </div>
