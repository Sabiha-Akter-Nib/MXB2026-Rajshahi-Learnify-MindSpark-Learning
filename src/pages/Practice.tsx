...
const bloomLevels = [
  ...
  { id: "apply", name: "Apply", color: "bg-yellow-500" },
  { id: "analyze", name: "Analyze", color: "bg-orange-500" },
  { id: "evaluate", name: "Evaluate", color: "bg-red-500" },
  { id: "create", name: "Create", color: "bg-purple-500" },
];
          ...
          >
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                {isBangla
                  ? "একটি বিষয় বা অধ্যায় লিখুন এবং AI আপনার জন্য প্রশ্ন তৈরি করবে!"
                  : "Enter a subject or chapter and AI will generate questions for you!"}
              </p>
            </div>
            ...
            <div className="max-w-md mx-auto space-y-4">
              ...
              <input
                ...
                placeholder={
                  isBangla
                    ? "যেমন: গণিত অধ্যায় ১, সাধারণ বিজ্ঞান..."
                    : "e.g., Math Chapter 1, General Science..."
                }
            ...
            <div className="pt-6">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {["Mathematics", "General Science", "English Grammar", "Bangladesh History"].map(
                  (t) => (
                    <button
                      key={t}
                      onClick={() => setTopic(t)}
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span
                  className={cn(
                    ...
                    bloomLevels.find((b) => b.id === currentQuestion.bloomLevel)?.color ||
                      "bg-primary",
                    "text-white"
                  )}
                >
