    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.div
            className="relative rounded-2xl sm:rounded-[1.4rem] overflow-hidden w-[85%] sm:w-[80%] aspect-square mx-auto"
            animate={{
              boxShadow: hovered
                ? `0 14px 35px -6px rgba(${mod.glowColor},0.5), 0 0 45px -10px rgba(${mod.glowColor},0.25)`
                : `0 5px 18px -5px rgba(${mod.glowColor},0.3)`,
            }}
          ...
          <div className="mt-2 text-center">
            <h3 className={cn("font-heading font-extrabold text-sm sm:text-base tracking-wide", mod.textColor)}>
              {mod.labelBn}
            </h3>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(147,112,219,0.5), transparent 70%)" }}
      />
      <div
        className="absolute -bottom-16 -right-16 w-44 h-44 rounded-full pointer-events-none opacity-15 blur-3xl"
        style={{ background: "radial-gradient(circle, rgba(72,191,166,0.5), transparent 70%)" }}
      />
