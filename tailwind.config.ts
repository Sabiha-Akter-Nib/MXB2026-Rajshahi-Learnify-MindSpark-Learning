  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(330 75% 65% / 0.4)" },
          "50%": { boxShadow: "0 0 40px hsl(330 75% 65% / 0.6), 0 0 60px hsl(330 75% 65% / 0.3)" },
        },
        "slide-up": {
        ...
        "border-glow": {
          "0%, 100%": { borderColor: "hsl(330 75% 65% / 0.3)" },
          "50%": { borderColor: "hsl(330 75% 65% / 0.6)" },
        },
        "tilt-left": {
